  ...
  return (
    <section id="anti-agency" className="relative bg-[#0c0c0e] py-10 md:py-14 text-white overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1440px] px-4 sm:px-6 md:px-12">
        {/* Section 5 Entire Box with Gradient Outline & Glowing Shadow Effect */}
        <div className="group/box relative rounded-[32px] sm:rounded-[40px] p-[1.5px] sm:p-[2px] bg-gradient-to-r from-red-500/40 via-[#d4af37]/45 via-50% to-rose-600/40 shadow-[0_0_35px_-10px_rgba(225,29,72,0.2),_0_0_25px_-5px_rgba(212,175,55,0.15)] transition-all duration-500 hover:shadow-[0_0_55px_-5px_rgba(225,29,72,0.35),_0_0_35px_0px_rgba(212,175,55,0.25)]">
          
          {/* Ambient Glowing Aura behind the Outline Gradient */}
          <div 
            aria-hidden 
            className="pointer-events-none absolute -inset-[1px] rounded-[33px] sm:rounded-[41px] bg-gradient-to-r from-red-600/25 via-[#d4af37]/30 via-50% to-rose-500/25 opacity-40 blur-md transition-opacity duration-500 group-hover/box:opacity-80" 
          />

          {/* Main Glassmorphic Inner Box */}
          <div className="relative rounded-[30.5px] sm:rounded-[38px] bg-[#121217]/95 p-6 sm:p-10 md:p-14 backdrop-blur-2xl overflow-hidden">
            {/* Soft Ambient Internal Corner Glows */}
            <div aria-hidden className="pointer-events-none absolute -left-20 -top-20 h-64 w-64 rounded-full bg-[#d4af37]/10 blur-3xl" />
            <div aria-hidden className="pointer-events-none absolute -right-20 -bottom-20 h-64 w-64 rounded-full bg-rose-600/10 blur-3xl" />
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {POINTS.map((p, i) => (
                <motion.div
                  ...
                  className="group relative flex flex-col justify-between overflow-hidden rounded-3xl border border-white/10 bg-[#181820]/90 p-6 sm:p-7 shadow-2xl backdrop-blur-md transition-all duration-500 hover:-translate-y-2 hover:border-red-500/60 hover:shadow-red-500/20"
                >
                  ...
                  {/* Scroll & Hover Ambient Gradient Overlay */}
                  <motion.div
                    initial={{ opacity: 0 }}
